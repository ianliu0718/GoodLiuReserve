function PostToGAS(profile){
	...
	//116版 送出使用者訊息
	var data_url = "https://script.google.com/macros/s/AKfycbx3Qzls02AZViFbn-TS5mKNSgLQjNmMDAHF24GDa7fC6bUR5QSaLqJtYqU_ejlm-DUl/exec";
	...
	var ianPostData = {
		...
		"ReserveProfile": JSON.stringify(profile)
	};
	$.ajax({
	type: "POST",
	url: data_url,
